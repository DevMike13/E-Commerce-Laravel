<div class="w-full h-screen flex justify-center pt-10">
    <section class="w-9/12 font-poppins dark:bg-gray-800">
        <div class="justify-center flex-1 px-4 py-4 bg-white border rounded-md dark:border-gray-900 dark:bg-gray-900 md:py-10 md:px-10 w-full">
          <div>
